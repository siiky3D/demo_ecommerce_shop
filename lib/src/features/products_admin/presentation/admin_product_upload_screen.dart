...
import 'package:demo_app/src/features/products_admin/presentation/admin_product_upload_controller.dart';
          ...
          child: Column(
            ...
            children: [
              if (templateProduct != null) ...[
                ...
                ErrorMessageWidget('Product template not found for ID: $productId'),
            ],
          ),
        ),
      ),
