...
import 'package:demo_app/src/common_widgets/alert_dialogs.dart';
...
import 'package:demo_app/src/features/products_admin/data/template_products_providers.dart';
import 'package:demo_app/src/features/products_admin/presentation/admin_product_edit_controller.dart';
import 'package:demo_app/src/features/products_admin/presentation/product_validator.dart';
...
class _AdminProductScreenContentsState extends ConsumerState<AdminProductEditScreenContents> {
  ...
  Future<void> _delete() async {
    ...
    if (delete == true) {
      ref.read(adminProductEditControllerProvider.notifier).deleteProduct(product);
    }
  }
...
class EditProductOptions extends StatelessWidget {
  const EditProductOptions({super.key, required this.onLoadFromTemplate, required this.onDelete});
