...
import 'package:demo_app/src/features/checkout/domain/checkout_session.dart';
...
class CheckoutSessionsRepository {
  ...
  DocumentReference<CheckoutSession> _checkoutSessionRef(UserID uid, String sessionId) =>
...
CheckoutSessionsRepository checkoutSessionsRepository(CheckoutSessionsRepositoryRef ref) {
