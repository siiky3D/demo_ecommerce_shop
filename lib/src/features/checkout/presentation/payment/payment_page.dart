import 'package:demo_app/src/common_widgets/async_value_widget.dart';
import 'package:demo_app/src/features/cart/application/cart_service.dart';
import 'package:demo_app/src/features/cart/domain/cart.dart';
import 'package:demo_app/src/features/cart/presentation/shopping_cart/shopping_cart_item.dart';
import 'package:demo_app/src/features/cart/presentation/shopping_cart/shopping_cart_items_builder.dart';
import 'package:demo_app/src/features/checkout/presentation/payment/payment_button.dart';
...
class PaymentPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ref.listen<AsyncValue<UserOrderID>>(latestUserOrderIdProvider, (previous, current) {
