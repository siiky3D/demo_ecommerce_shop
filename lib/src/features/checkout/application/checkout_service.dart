...
import 'package:demo_app/src/features/checkout/data/checkout_sessions_repository.dart';
import 'package:demo_app/src/features/checkout/data/payment_sheet_repository.dart';
import 'package:demo_app/src/features/checkout/data/payments_repository.dart';
import 'package:demo_app/src/features/checkout/domain/checkout_session_platform.dart';
...
class CheckoutService {
  ...
  Future<void> pay({
    ...
    final sessionId = await _ref.read(checkoutSessionsRepositoryProvider).writeCheckoutSession(
          uid: user.uid,
