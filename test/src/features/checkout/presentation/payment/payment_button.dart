...
import 'package:demo_app/src/utils/html_window_url_non_web.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
// * a conditional import is required here since on mobile we can't use dart:html
// import 'package:demo_app/src/utils/html_window_url_stub.dart'
//     if (dart.library.html) 'package:demo_app/src/utils/html_window_url_web.dart'
//     if (dart.library.io) 'package:demo_app/src/utils/html_window_url_non_web.dart';
