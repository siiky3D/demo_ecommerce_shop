...
import 'package:demo_app/src/features/cart/presentation/add_to_cart/add_to_cart_controller.dart';
...
void main() {
  ...
  group('addItem', () {
    test('item added with quantity = 2, success', () async {
      ...
      final addToCartController = container.read(addToCartControllerProvider.notifier);
      ...
      final itemQuantityController = container.read(itemQuantityControllerProvider.notifier);
